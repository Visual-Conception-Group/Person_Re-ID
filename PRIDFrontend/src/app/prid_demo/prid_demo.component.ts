...
@Component({
    selector: "person-reid-demo",
    templateUrl: "prid_demo.component.html",
    styleUrls: ["./prid_demo.component.css"]
})

export class PridDemoComponent implements OnInit {
    ...
    public get_frame_count_v2() {
        ...
        let get_frame_service = this._video_service.get_cached_frame_count(this.username).subscribe((response: any) => {
    ...
    public prepare_demo() {
        ...
        this._video_service.prepare_demo(this.username).subscribe((response: any) => {
            // console.log(response);
        });
